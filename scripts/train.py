...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pnn',
                       choices=['pnn', 'pnn_exp1', 'pnn_exp2', 'pnn_exp3', 'pnn_exp4', 'bert'],
                       help='Model type: pnn (baseline), pnn_exp1 (dual blocks), pnn_exp2 (dual refiners), pnn_exp3 (big single FFN), pnn_exp4 (3 transformer blocks)')
